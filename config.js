...
var config = {
  ...
  getArticleInfo_url:host+"api/Common/getArticleInfo",
  getLableHot_url:host+"api/Common/getLableHot",
  ...
  setShareTime_url:host+"api/Share/setShareTime",

  setPay_url:host+"api/Order/setPay",
  setOrderPay_url:host+"pay/Pay/setPay",
