...
Page({
  ...
  onTehui(){
    console.log('特惠')
    wx.navigateTo({
      url: '../product/list?type=preferential'
    })
  },
  onZhuanzhen(){
    console.log('转诊')
    wx.navigateTo({
      url: '../product/list?type=referral'
    })
  },
  onFanyong(){
    console.log('返佣')
  ...
  onRexiao(){
    console.log('热销')
    wx.navigateTo({
      url: '../product/list?type=hot'
    })
  },
  onXiaoguo(){
    console.log('效果')
    wx.navigateTo({
      url: '../product/list?type=effect'
    })
  },
  onHaohui(){
    console.log('好货')
    wx.navigateTo({
      url: '../product/list?type=superior'
    })
  },
