...
Page({
  ...
  getGoodsList(){
    ...
    wx.request({
      ...
      data:{"source":"wx","page":that.data.page,"num":that.data.num,"searchname":that.data.value},
      method: "post",
      success: function (res) {
  ...
  onLoad: function (options) {
    ...
    wx.request({
      url: config.getGoodsList_url,
      data:{"source":"wx","page":that.data.page,"num":that.data.num,"searchname":'医疗美容'},
      method: "post",
      success: function (res) {
        console.log('获取商品',res.data)
        wx.stopPullDownRefresh();
